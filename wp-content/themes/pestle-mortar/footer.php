  <footer class="footer page-wrap" role"contentinfo">
    ...
    ?>
    <small>&copy; 2005 - <?php echo date("Y"); echo " "; bloginfo('name'); ?><?php if( $tt_settings['author_credits'] ) : ?> | Designed by <a href="http://tinktank.in">Tink <span class="tinktank">⚒</span> Tank</a><?php endif; ?></small>
