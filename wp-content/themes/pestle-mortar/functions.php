<?php 
  ...
  if ( function_exists( 'add_image_size' ) ) { 
    add_image_size( 'homepage-tile', 400, 400, true);
  }
  ...
  function cd_meta_box_cb( $post )
  {
    ...
    $background_pattern = isset( $values['background_pattern'] ) ? esc_attr( $values['background_pattern'][0] ) : '';
    ...
    <p>
      ...
      <input placeholder="Blue" class="widefat" type="text" name="background_color" id="background_color" value="<?php echo $background_color; ?>" />
    </p>

    <p>
      <label for="background_pattern">Background Pattern</label>
      <input placeholder="http://" class="widefat" type="text" name="background_pattern" id="background_pattern" value="<?php echo $background_pattern; ?>" />
    </p>
  ...
  function cd_meta_box_save( $post_id )
  {
    ...
    if( isset( $_POST['background_pattern'] ) )
      update_post_meta( $post_id, 'background_pattern', wp_kses( $_POST['background_pattern'], $allowed ) );
  }
