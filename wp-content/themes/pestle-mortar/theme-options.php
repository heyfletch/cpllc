...
function tt_theme_options_page() {
	...
	<p>Upload logo (150px x 150px) via <a href="<?php echo get_option('siteurl'); ?>/wp-admin/media-new.php">Add new media</a></p>
	</td>
	</tr>

	<tr valign="top"><th scope="row"><label for="site_color">Site Color:</label></th>
	<td>
	<input id="site_color" name="tt_options[site_color]" type="text" placeholder="red" value="<?php  esc_attr_e($settings['site_color']); ?>" />
	</td>
	</tr>

	<tr valign="top"><th scope="row"><label for="background_image">Background Image:</label></th>
	<td>
	<input id="background_image" name="tt_options[background_image]" type="text" placeholder="http://" value="<?php  esc_attr_e($settings['background_image']); ?>" />
	<p>Upload image via <a href="<?php echo get_option('siteurl'); ?>/wp-admin/media-new.php">Add new media</a></p>	
	</td>
	</tr>

	<tr valign="top"><th scope="row"><label for="background_color">Background Color:</label></th>
	<td>
	<input id="background_color" name="tt_options[background_color]" type="text" placeholder="Red" value="<?php  esc_attr_e($settings['background_color']); ?>" />
	</td>
	</tr>

	<tr valign="top"><th scope="row"><label for="background_pattern">Background Pattern:</label></th>
	<td>
	<input id="background_pattern" name="tt_options[background_pattern]" type="text" placeholder="http://" value="<?php  esc_attr_e($settings['background_pattern']); ?>" />
	<p>Upload pattern via <a href="<?php echo get_option('siteurl'); ?>/wp-admin/media-new.php">Add new media</a></p>
	</td>
	</tr>
